...
int result = GetQuadrant(num1, num2);

if (result == 0) Console.WriteLine("The point is onthe axes");
else Console.WriteLine($"The point in the quarter {result}");
*/

//Задача 2. Напишите программу, которая по заданному номеру четверти,
// показывает диапазон возможных координат точек в этой четверти (x и y).
void ShowCoordinate(int quad)
{
    if (quad <= 0 || quad >4) Console.WriteLine("error");
    else if (quad = 1) Console.WriteLine("We are on the axes")
    else if (quad = 2) Console.WriteLine("We are on the axes")
    else if (quad = 3) Console.WriteLine("We are on the axes")
    else if (quad = 4) Console.WriteLine("We are on the axes")
}
Concole.Write("Enter number");

// Задача 3. Напишите программу, которая принимает на вход число
// (N) и выдаёт квадраты чисел от 1 до N.
